...
public class CompanyService {
        ...
        public ServiceResponseDto updateService(UUID serviceId, ServiceRequestDto dto) {
                ...
                if (!service.getName().equals(dto.getName()) &&
                                serviceRepository.existsByNameAndCompanyId(dto.getName(),
                        ...
                        case FREE:
                                if (activeServiceCount >= 3) {
                                        throw new RuntimeException(
                                                        "FREE plan allows maximum 3 services. Upgrade to create more.");
                                }
                                break;
                        case BASIC:
                                if (activeServiceCount >= 10) {
                                        throw new RuntimeException(
                                                        "BASIC plan allows maximum 10 services. Upgrade to create more.");
                                }
                                break;
                        case PREMIUM:
